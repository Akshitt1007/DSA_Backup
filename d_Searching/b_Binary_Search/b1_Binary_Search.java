package d_Searching.b_Binary_Search;
    /*
     Binary search - O(log n)

     Why it is O(log n) ?

     If 𝑛 = 16: 16 → 8 → 4 → 2 → 1 , which takes 4 steps (i.e., log  2 ( 16 ) = 4 log 2  (16)=4).
     If 𝑛 = 32: 32 → 16 → 8 → 4 → 2 → 1 , which takes 5 steps (i.e., log  2 ( 32 ) = 5 log 2  (32)=5).
